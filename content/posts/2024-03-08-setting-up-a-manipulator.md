...
---
<!-- Post 7 -->
Let's take a look at how we can set up a framework for streamlined simulation and hardware control of a manipulator. The robot under consideration is Ufactory's Lite 6 manipulator and the simulation/setup tool used is Drake.
...
* Drake's python bindings have grown over the years and is at the point where almost the entire library can be accessed through  python
